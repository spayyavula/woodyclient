/*
  # Fix Android Build Configurations

  1. Changes
     - Adds checks to prevent duplicate policies
     - Creates android_build_configurations table if not exists
     - Adds proper RLS policies with existence checks
     - Creates indexes for performance optimization
  
  2. Security
     - Enables RLS on the table
     - Adds policies for authenticated users and service role
*/
