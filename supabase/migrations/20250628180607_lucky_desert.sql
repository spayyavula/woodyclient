/*
  # Fix deployment progress functions and add default data

  1. New Functions
    - Improved `update_deployment_progress` function to handle edge cases
    - Added `get_deployment_progress` function with fallbacks
    - Added `get_deployment_events` function with fallbacks
    
  2. Default Data
    - Added default deployment record creation
    - Added default events for existing deployments
