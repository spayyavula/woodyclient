/*
  # Add Visual Progress Tracking for Android Deployments

  1. New Tables
    - `deployment_progress_events` - Detailed event tracking for deployments
    - `deployment_progress` - Step-by-step progress tracking

  2. Changes
    - Add visual progress tracking fields to `android_deployments` table
    - Create trigger to automatically update deployment progress
