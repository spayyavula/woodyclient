/*
  # Fix Android Deployment Progress Functions
  ...
  2. Data
    - Creates a default deployment record with ID 366
    - Adds a default progress event for that deployment
*/
...
DECLARE
  user_uuid uuid;
BEGIN
  -- Get the first user ID from the users table, or create a placeholder
