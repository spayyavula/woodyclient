/*
  # Fix Deployment Progress Functions and Default Data

  1. Functions
    - Create/replace update_deployment_progress function
    - Create get_deployment_progress function with fallback
    - Create get_deployment_events function with fallback
  
  2. Default Data
    - Add default deployment record using auth.users instead of users
    - Add default event for existing deployments
*/
