/*
  ...
  1. Changes
     - Use OVERRIDING SYSTEM VALUE to insert into identity column
     - Fix timestamp column references in functions
     - Add fallback functions for deployment progress and events
